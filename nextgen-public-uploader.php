...
function npu_plugin_activation() {
	...
	if ( ! get_option( 'npu_default_gallery' ) ) {
        ...
        update_option( 'npu_use_hash', 			        'Enabled' );
        update_option( 'npu_use_html5_multiple',	    '' );
        update_option( 'npu_default_uploads', 			'1' );
        update_option( 'npu_max_uploads', 			    '5' );
        update_option( 'npu_max_uploads_msg', 			'Max: ' );
		update_option( 'npu_image_description_select', 	'Enabled' );
		update_option( 'npu_description_text', 			'' );
        update_option( 'npu_description_placeholder', 	'' );
        ...
        update_option( 'npu_min_width', 			    '-1' );
        update_option( 'npu_min_height', 			    '-1' );
        update_option( 'npu_max_width', 			    '-1' );
        update_option( 'npu_max_height', 			    '-1' );
        update_option( 'npu_max_filesize', 			    '-1' );
...
function load_nggpu() {
	...
	include_once( dirname( __FILE__ ) . '/tinymce/tinymce.php' ); // TinyMCE
}
...
function npu_plugin_settings() {
    ...
    register_setting( 'npu_settings', 'npu_use_hash',				    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_use_html5_multiple',		    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_default_uploads',		    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_max_uploads',		        'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_max_uploads_msg',		    'npu_settings_sanitization' );
    ...
    register_setting( 'npu_settings', 'npu_description_placeholder',	'npu_settings_sanitization' );
    ...
    register_setting( 'npu_settings', 'npu_min_width',				    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_min_height',				    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_max_width',				    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_max_height',				    'npu_settings_sanitization' );
    register_setting( 'npu_settings', 'npu_max_filesize',				'npu_settings_sanitization' );
    ...
    add_settings_field( 'npu_use_hash',     			__( 'Use hash in filename', 'nextgen-public-uploader' ),	    'npu_settings_checkbox', 	'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_use_hash', 				    'description' => '',	'value' => 'Enabled', 'label' => __( 'Use a generated hash in the uploaded filename.', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_use_html5_multiple',     	__( 'Use HTML5 multiple file upload (default single)', 'nextgen-public-uploader' ),'npu_settings_checkbox', 'nextgen-public-uploader',  'npu_settings',     array( 'ID' => 'npu_use_html5_multiple', 	'description' => '',	'value' => 'Enabled', 'label' => __( 'Use HTML5 multiple file upload (only if no Image Description text)?', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_default_uploads',          __( 'How many default single image inputs to show:', 'nextgen-public-uploader' ),  'npu_settings_text',     'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_default_uploads',	    'description' => __( 'How many upload inputs (single upload) to show by default (empty = 1) ? In widget mode only 1 is shown.', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_max_uploads',              __( 'Maximum images in one upload:', 'nextgen-public-uploader' ),    'npu_settings_text',     'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_max_uploads',	        'description' => __( 'In single upload limits max inputs shown, in multiple upload limits via Javascript total number of images? (-1 = ignore)', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_max_uploads_msg', 		    __( 'Max uploads msg in upload button:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_max_uploads_msg',			'description' => __( 'What message should be displayed after upload button text (empty for no msg).', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_image_description_select', __( 'Show Description Field:', 'nextgen-public-uploader' ),		'npu_settings_checkbox', 	'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_image_description_select',	'description' => '',	'value' => 'Enabled', 'label' => __( 'Enable the Image Description text field (only for single upload).', 'nextgen-public-uploader' ) ) );
    ...
    add_settings_field( 'npu_description_placeholder', 	__( 'Image Description input placeholder:', 'nextgen-public-uploader' ),	        'npu_settings_text', 	'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_description_placeholder',		'description' => __( 'Default text to show as placeholder in the Image Description input field.', 'nextgen-public-uploader' ) ) );
    ...
    add_settings_field( 'npu_no_file', 					__( 'No File Selected Warning:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_no_file',					'description' => __( 'Warning displayed when no file has been selected for upload(not shown if maximum uploads > default uploads).', 'nextgen-public-uploader' ) ) );
    ...
    add_settings_field( 'npu_upload_success', 			__( 'Upload Success Message:', 'nextgen-public-uploader' ),		'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_upload_success',			'description' => __( 'Message displayed when an image (or images) has been successfully uploaded.', 'nextgen-public-uploader' ) ) );
    ...
    add_settings_field( 'npu_min_width',     			__( 'Minimum images width [px]:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_min_width', 				'description' => __( 'The minimum width of an image to upload in Pixels (-1 = ignore)', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_min_height',     			__( 'Minimum images height [px]:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_min_height', 				'description' => __( 'The minimum height of an image to upload in Pixels (-1 = ignore)', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_max_width',     			__( 'Maximum images width [px]:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_max_width', 				'description' => __( 'The maximum width of an image to upload in Pixels (-1 = ignore)', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_max_height',     			__( 'Maximum images height [px]:', 'nextgen-public-uploader' ),	'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_max_height', 				'description' => __( 'The maximum height of an image to upload in Pixels (-1 = ignore)', 'nextgen-public-uploader' ) ) );
    add_settings_field( 'npu_max_filesize',     		__( 'Maximum filesize [kB]:', 'nextgen-public-uploader' ),	    'npu_settings_text', 		'nextgen-public-uploader',	'npu_settings',		array( 'ID' => 'npu_max_filesize', 				'description' => __( 'The maximum filesize of an image to upload in kB (-1 = ignore)', 'nextgen-public-uploader' ) ) );
